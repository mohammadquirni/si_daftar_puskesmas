...
class Pasien {
	...
	function insert() {
        ...
        $stmt->bindParam(4, $this->tempat_tanggal_lahir);
	...
	function readOne() {
        ...
        $this->nik = $row['nik'];
        $this->nama = $row['nama'];
        $this->tempat_tanggal_lahir = $row['tempat_tanggal_lahir'];
	...
	function update() {
        ...
        $stmt->bindParam(':tempat_tanggal_lahir', $this->tempat_tanggal_lahir);
